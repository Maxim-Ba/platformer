...
In-scene overlay-меню персонажа в GameScene: вкладки (инвентарь, скилы, характеристики, умения, карта), горячие клавиши, горизонтальная навигация и заморозка геймплея. Контент вкладок на v1 — mock.
