...
Плавное слежение камеры за игроком через port/adapter: центрирование, люфт при смене направления, clamp к границам уровня и тестируемая логика follow без Phaser.
