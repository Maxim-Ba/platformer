...
Конфигурация связанного мира: entry room, реестр известных комнат, соглашение roomId = map asset id. Связность дверей задаётся в Tiled, не дублируется в графе.
