...
Spritesheet-анимации игрока (idle, run, jump, fall, attack hook), Phaser animation registry, и presentation resolver, синхронизирующий `PlayerState` с кадровыми анимациями.
